<?php
/**
 * Render template of the `creabb/card-group` block.
 *
 * 1:1-Uebersetzung von `areoi_render_block_card_group()`. Klassenkette:
 *
 *   block-<uuid>  card-group  <className>  <hide-Kaskade mit flex>
 *
 * Der einzige Block der Kartenfamilie ohne Farbklassen.
 *
