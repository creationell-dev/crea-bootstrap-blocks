<?php
/**
 * Render template of the `creabb/card-body` block.
 *
 * 1:1-Uebersetzung von `areoi_render_block_card_body()`. Wie `card`, mit zwei
 * Unterschieden: Grundklasse `card-body` und Sichtbarkeitskaskade mit `block`
 * statt `flex`.
 *
