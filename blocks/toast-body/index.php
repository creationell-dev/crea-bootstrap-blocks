<?php
/**
 * Render template of the `creabb/toast-body` block.
 *
 * 1:1-Uebersetzung von `areoi_render_block_toast_body()` (`blocks/toast-body.php` des
 * Alt-Plugins). Klassenreihenfolge woertlich:
 *
 *   block-<uuid>  toast-body  <className>
 *
