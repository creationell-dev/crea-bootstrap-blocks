<?php
/**
 * Render template of the `creabb/offcanvas-body` block.
 *
 * 1:1-Uebersetzung von `areoi_render_block_offcanvas_body()` (`blocks/offcanvas-body.php` des
 * Alt-Plugins). Klassenreihenfolge woertlich:
 *
 *   block-<uuid>  offcanvas-body  <className>
 *
