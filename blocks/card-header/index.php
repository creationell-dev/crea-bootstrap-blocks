<?php
/**
 * Render template of the `creabb/card-header` block.
 *
 * 1:1-Uebersetzung von `areoi_render_block_card_header()`
 * (`blocks/card-header.php` des Alt-Plugins). Klassenreihenfolge woertlich
 * uebernommen:
 *
 *   block-<uuid>  card-header  <className>  <background>  <text_color>
