<?php
/**
 * Render template of the `creabb/modal-body` block.
 *
 * 1:1-Uebersetzung von `areoi_render_block_modal_body()` (`blocks/modal-body.php` des
 * Alt-Plugins). Klassenreihenfolge woertlich:
 *
 *   block-<uuid>  modal-body  <className>
 *
